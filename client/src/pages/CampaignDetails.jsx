            ...
            <div className="mt-[20px] flex flex-col gap-4">
              {donators.length > 0 ? donators.map((item, index) => (
                ...
                className="flex justify-between items-center gap-4">
                  ...
                  text-[#b2b3bd] leading-[26px] break-ll">{index + 1}. {item.donator}
                  </p>
                  <p className="font-epilogue font-normal text-[16px] 
                  text-[#808191] leading-[26px] break-ll">{item.donation}
                  </p>
                </div>
              )) : (
                <p className="font-epilogue font-normal 
          ...
          rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              <div className="my-[20px] p-4 bg-[#13131a] rounded-[10px]">
                ...
                leading-[22px] text-[#808191]">Support the project for no reward, just 
